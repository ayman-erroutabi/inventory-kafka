...
import inventory.inventorykafka.dtos.deserializer.OrderDeserializer;
...
public class KafkaConsumerConfig {
    ...
    @Bean
    public KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<String, OrderDTO>> orderFactory(
